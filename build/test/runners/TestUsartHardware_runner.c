...
int main(void)
{
  ...
  run_test(testInitShouldConfigureUsartPeripheralByCallingConfiguratorAppropriately, "testInitShouldConfigureUsartPeripheralByCallingConfiguratorAppropriately", 15);
  run_test(testTransmitStringShouldSendDesiredStringOutUsingUsart, "testTransmitStringShouldSendDesiredStringOutUsingUsart", 27);
